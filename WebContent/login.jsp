	...
	<div class="container">
		<div class="row-1 ">
			<div class="head-Title">
				<div class="col-3" ></div>
				<div class="col-xs-1 center-block" style="font-size :50px; color:white; font-family:Arial Black, Gadget, sans-serif; align-items: center;" > Police  </div>
				<div class="col-3" ></div>
			</div>
			...
			<div class="login-page">
		    	...
		    	<form class="register-form" action="login">
		        	...
		        	<div class="col-3"><br></div> 
		        		...
		        		<input class="btn btn-success" type="submit" value="SUBMIT" style="height:50px;color:white; background-color:blue; padding:3px"/>
